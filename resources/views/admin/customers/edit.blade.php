...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Edit Customer
        </h4>
    </div>
    ...
    <div class="col-lg-12">
        <section class="card">
            <header class="card-header bg-info">
                <h4 class="mb-0 text-white" >Edit Customer Form</h4>
            </header>
            <div class="card-body">
                <form method="post" action="{{URL::to('admin/customers')}}/{{Crypt::encryptString($customer->id)}}" >
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$customer->customer_phone}}" 
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$customer->customer_email}}" 
