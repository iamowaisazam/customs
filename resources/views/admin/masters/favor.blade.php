...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Favor</h4>
    </div>
...
<form method="post" enctype="multipart/form-data" action="{{URL::to('admin/masters/favor')}}" >
    @csrf

    <?php 
      $pol = isset($data['favor']) ? json_decode($data['favor']) : [];
    ?>
    ...
    <div class="row">
        <div class="col-lg-12">
            <section class="card">            
                ...
                <h4 class="mb-0 text-white">All Favor</h4>
                </header>
                <div class="card-body">
                    ...
                    <div class="text-center">
                     ...
                     <div class="row all">
                        @foreach ($pol as $key => $item)        
                            <div class="col-md-12">
                                <label class="py-2">Favor</label>
                                <div class="form-group d-flex">
                                    <input class="form-control"name="favor[{{$key}}]" value="{{$item}}" />
        ...
        $('.add').on('click', function() {
            ...
            let add = `
                <div class="col-md-12">
                    <label class="py-2">Favor</label>
                    <div class="form-group d-flex">
                        <input class="form-control" name="favor[${uid}]" />
                        <button type="button" class="remove btn btn-danger">X</button>
                    </div>
                </div>`;
