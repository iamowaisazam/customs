...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Vessels</h4>
    </div>
...
<form method="post" enctype="multipart/form-data" action="{{URL::to('admin/masters/vessels')}}" >
    @csrf
    <?php $vessels = isset($data['vessels']) ? json_decode($data['vessels']) : []; ?>

    <div class="row">
        <div class="col-lg-12">
            <section class="card">            
                <header class="card-header bg-info">
                <h4 class="mb-0 text-white">All Vessels</h4>
                </header>
                <div class="card-body">
                    <div class="text-center">
                     ...
                     <div class="row all">
                        @foreach ($vessels as $key => $item)        
                            <div class="col-md-12">
                                <label class="py-2">Vessel</label>
                                <div class="form-group d-flex">
                                    <input class="form-control"name="vessels[{{$key}}]" value="{{$item}}" />
    ...
    $(document).ready(function() {
        ...
        $('.add').on('click', function() {
            ...
            let add = `<div class="col-md-12">
                    <label class="py-2">Vessel</label>
                    <div class="form-group d-flex">
                        <input class="form-control" name="vessels[${uid}]" />
                        <button type="button" class="remove btn btn-danger">X</button>
                    </div>
                </div>`;
