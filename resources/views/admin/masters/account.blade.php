...
<form method="post" enctype="multipart/form-data" action="{{URL::to('admin/masters/account')}}" >
    @csrf

    <?php 
      $pol = isset($data['account']) ? json_decode($data['account']) : [];
    ?>
    ...
    <div class="row">
        <div class="col-lg-12">
            <section class="card">            
                ...
                <h4 class="mb-0 text-white">All Account</h4>
                </header>
                <div class="card-body">
                    ...
                    <div class="text-center">
                     ...
                     <div class="row all">
                        @foreach ($pol as $key => $item)        
                            <div class="col-md-12">
                                <label class="py-2">Account</label>
                                <div class="form-group d-flex">
                                    <input class="form-control"name="account[{{$key}}]" value="{{$item}}" />
        ...
        $('.add').on('click', function() {
            ...
            let add = `
                <div class="col-md-12">
                    <label class="py-2">Account</label>
                    <div class="form-group d-flex">
                        <input class="form-control" name="account[${uid}]" />
                        <button type="button" class="remove btn btn-danger">X</button>
                    </div>
                </div>`;
