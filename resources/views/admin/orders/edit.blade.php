                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$data->customer_notes}}" name="customer_notes" class="form-control" 
                                placeholder="Customer Notes">
                                @if($errors->has('customer_notes'))
                                <p class="invalid-feedback" >{{ $errors->first('customer_notes') }}</p>
                                @endif 
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td width="150" align="center" class="font-500">
                                        PKR {{$data->subtotal}}</td>                            
                                </tr>
                                <tr>
                                    <th colspan="4" class="text-end" >Delivery Charges</th>
                                    <td width="150" align="center" class="font-500">
                                        PKR {{$data->delivery_charges}}</td>                            
                                </tr>
                                <tr>
